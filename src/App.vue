<template>
  <div class="banner-1 flex flex-col justify-between" :style="backgroundStyle">
    <!-- NavBar -->
    <nav
...
.banner-1 {
    ...
    height: 100vh;
    /* Set background-image URL from script */
...
export default {
  data() {
    return {
      showMenu: false,  // Define showMenu here
      backgroundStyle: {
        backgroundImage: `url(${imageUrl})`,  // Use the imported URL here
